 ...
 * @throws {Error} Throws an error if the number is not within the allowed range or not an integer.
 */
function integerToRoman(num) {
  ...
  // NUEVO: Validar que el número sea estrictamente un número entero (rechaza decimales)
...
function handleConversion() {
  ...
  try {
    if (mode === 'intToRoman') {
      ...
      // Modificado para usar Number() y mantener los decimales si el usuario los introduce, 
      // de modo que nuestra nueva validación isInteger pueda atraparlos.
